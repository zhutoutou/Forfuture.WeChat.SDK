...
namespace Forfuture.Core.Domain.Uow
{
    public interface IActiveUnitOfWork
    {
        ...
        /// </summary>
        /// <param name="filterNames">One or more filter names. <see cref="ForfutureDataFilters"/> for standard filters.</param>
        ...
        /// </summary>
        /// <param name="filterName">Name of the filter. <see cref="ForfutureDataFilters"/> for standard filters.</param>
